...
---
- ให้ นศ. ทำการ Fork repo นี้ไปเป็นของ นศ. โดยให้กำหนดชื่อในรูปแบบ <github_username>/quiz2**xx**-<student_id> โดย **xx** คือ **หมายเลขที่นั่งของ นศ.**  เช่น  awesome_code/quiz2**07**-680610999 (เลขที่นั่ง คือ 7)
